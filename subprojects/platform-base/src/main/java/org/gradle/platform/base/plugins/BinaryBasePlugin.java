...
public class BinaryBasePlugin implements Plugin<Project> {
    ...
    static class Rules extends RuleSource {
        ...
        @Mutate
        void registerNodeInitializerExtractors(NodeInitializerRegistry nodeInitializerRegistry, BinarySpecFactory binarySpecFactory, ModelSchemaStore schemaStore, ManagedStructBindingStore bindingStore) {
            nodeInitializerRegistry.registerStrategy(new FactoryBasedStructNodeInitializerExtractionStrategy<BinarySpec>(binarySpecFactory, schemaStore, bindingStore));
        }
