...
public class LanguageBasePlugin implements Plugin<Project> {
    ...
    static class Rules extends RuleSource {
        ...
        @Mutate
        void registerSourceSetNodeInitializer(NodeInitializerRegistry nodeInitializerRegistry, LanguageSourceSetFactory languageSourceSetFactory, ModelSchemaStore schemaStore, ManagedStructBindingStore bindingStore) {
            nodeInitializerRegistry.registerStrategy(new FactoryBasedStructNodeInitializerExtractionStrategy<LanguageSourceSet>(languageSourceSetFactory, schemaStore, bindingStore));
        }
