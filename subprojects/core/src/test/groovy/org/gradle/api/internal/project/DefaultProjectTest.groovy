...
class DefaultProjectTest {
    ...
    NewManagedProxyFactory managedProxyFactory = context.mock(NewManagedProxyFactory.class)
    ...
    void setUp() {
        ...
        context.checking {
            ...
            allowing(serviceRegistryMock).get(NewManagedProxyFactory); will(returnValue(managedProxyFactory))
