...
public class PatternSet implements AntBuilderAware, PatternFilterable {
    ...
    private static final PatternSpecFactory PATTERN_SPEC_FACTORY = new PatternSpecFactory();
    ...
    public Spec<FileTreeElement> getAsSpec() {
        return PATTERN_SPEC_FACTORY.createSpec(true, this);
    }

    public Spec<FileTreeElement> getAsIncludeSpec() {
        return PATTERN_SPEC_FACTORY.createIncludeSpec(true, this);
    }

    public Spec<FileTreeElement> getAsExcludeSpec() {
        return PATTERN_SPEC_FACTORY.createExcludeSpec(true, this);
    }
