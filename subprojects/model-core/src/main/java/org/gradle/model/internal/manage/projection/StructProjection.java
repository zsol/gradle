...
import org.gradle.model.internal.manage.instance.*;
...
public class StructProjection<M> extends TypeCompatibilityModelProjectionSupport<M> {
    ...
    protected ModelView<M> toView(final MutableModelNode modelNode, final ModelRuleDescriptor ruleDescriptor, final boolean writable) {
        return new ModelView<M>() {
            ...
            public ModelType<M> getType() {
                return StructProjection.this.getType();
            }
            ...
            class State implements ModelElementState {
                ...
                public Object get(String name) {
                    ...
                    NewModelProperty<?> property = schema.getProperty(name);
                ...
                private <T> T doGet(NewModelProperty<T> property, String propertyName) {
                ...
                private <T> Object doSet(String name, Object value, NewModelProperty<T> property) {
                    ModelSchema<T> propertySchema = property.getSchema();
