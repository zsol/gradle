...
public class ModelTypeInitializationException extends GradleException {
    ...
    private static <T> String toMessage(NodeInitializerContext<T> context,
        ...
        if (propertyContextOptional.isPresent()) {
            ...
            } else if (isAScalarCollection(propertyContext)) {
    ...
    private static boolean isAScalarCollection(NodeInitializerContext.PropertyContext propertyContext) {
        Class<?> concreteClass = propertyContext.getType().getConcreteClass();
